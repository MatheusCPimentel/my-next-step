...
export function AddColumnButton({ onAdd, disabled }: AddColumnButtonProps) {
  ...
  if (editing) {
    return (
      <div className="h-full w-[272px] shrink-0 bg-surface rounded-xl p-3">
        <Input
          ref={inputRef}
          value={value}
  ...
  return (
    <button
      ...
      className="group/add h-full w-[272px] shrink-0 rounded-xl border border-dashed border-border-hover text-muted hover:border-purple hover:text-purple-soft hover:bg-purple/5 transition-colors flex flex-col items-center justify-center gap-2 p-3"
    >
